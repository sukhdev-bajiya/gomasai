                    ...
                    <tbody>
                        {
                            translate.map((data, index) => {
                                return <tr key={index}>
                                    <td>{data[0]}</td>
                                    <td>{data[1]}</td>
                                    <td onClick={() => editText(index)}>
                                        <svg xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 194.436 194.436" space="preserve" >
                                            <g>
                                    ...
                                    <td onClick={() => deleteText(index)}>
                                        <svg xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 354.319 354.319" space="preserve">
