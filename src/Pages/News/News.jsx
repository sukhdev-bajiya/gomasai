...
function News() {
    ...
    const [imageData, setImageData] = React.useState({ articles: [] });
    ...
    const searchNewsData = async () => {
        try {
            ...
            let url = `https://gnews.io/api/v4/search?&token=169817000b938e4a84d28a8d84a20e79&nullable=title,description,content`;
    ...
    return (
        <div className='news__page'>
            ...
            <div className='news__newsDataShow'>
                <h1 style={{ textAlign: "center" }}>Top {imageData.articles.length} News</h1>
                {
                ...
                <div className='news__newsfullData' id='news__newsfullData'>
                    ...
                    <div className='news__newsfullIteamData'>
                        ...
                        <p>
                            <a href={imageData.articles[showsingledata].url} target="_blank">Read more...</a>
                            <span>{imageData.articles[showsingledata].publishedAt}</span>
                            <a href={imageData.articles[showsingledata].source.url} target="_blank">{imageData.articles[showsingledata].source.name}</a>
                        </p>
